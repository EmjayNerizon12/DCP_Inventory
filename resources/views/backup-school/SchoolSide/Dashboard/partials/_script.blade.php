<script>
    async function getDashboardData() {
        const response = await fetch('Dashboard/api/api-get-information');
        const res = await response.json();
        const data = res.data;
        const container = document.getElementById('equipment-card-info');
        container.classList.add('grid', 'md:grid-cols-5', 'grid-cols-1', 'gap-4', 'my-2');
            ...
            <div class="card-dashboard">
                            <div class="flex flex-row items-start w-full gap-4">
                                <div
                                    ...
                                    <div class="bg-blue-600 text-white w-16 h-16 rounded-full flex items-center justify-center">
                                        <!-- Archive Icon -->
                                ...
                                <div class="w-full">
                                    <p class="card-title">Total School Employees</p>
                                    <h3 class="card-value">${data.school_employee_count}</h3>
                                </div>
        ...
        internet_card.innerHTML = `
                        ...
                        <g id="SVGRepo_iconCarrier">
                            ...
                            <g>
                                ...
                                <div class="w-full">
                                    <p class="card-title">Total Internet Connections</p>
                                    <h3 class="card-value">${data.internet_count}</h3>
                                </div>
                         ...
                         <div class="card-dashboard ">
                            <div class="flex flex-row items-start w-full gap-4">
                             ...
                             <g id="SVGRepo_iconCarrier">
                                ...
                                <div class="w-full">
                                    <p class="card-title">Total CCTV Equipment</p>
                                    <h3 class="card-value">${data.cctv_count}</h3>
                                </div>
                         ...
                         <div class="card-dashboard ">
                            <div class="flex flex-row items-start w-full gap-4">
                             ...
                             <g id="SVGRepo_iconCarrier">
                                ...
                                <div class="w-full">
                                    <p class="card-title">Total Biometric Equipment</p>
                                    <h3 class="card-value">${data.biometric_count}</h3>
                                </div>
                         ...
                         <div class="card-dashboard ">
                            <div class="flex flex-row items-start w-full gap-4">
                                <div
                                    ...
                                    <div class="bg-blue-600 text-white w-16 h-16 rounded-full flex items-center justify-center">
                                        <!-- Archive Icon -->
                                        <svg viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" class="w-10 h-10" fill="currentColor">
                                                <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                                                <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                                                <g id="SVGRepo_iconCarrier">
                                                    <defs>
                                ...
                                <div class="w-full">
                                    <p class="card-title">Other School Equipment</p>
                                    <h3 class="card-value">${data.other_equipment}</h3>
                                </div>
    ...
    async function getDCPData() {
        //SECOND ROW OF CARDS
        const response = await fetch('Dashboard/api/api-get-dcp-information');
        const res = await response.json();
        const data = res.data;
        const container = document.getElementById('dcp-card-info');
        container.classList.add('grid', 'md:grid-cols-5', 'grid-cols-1', 'gap-4', 'my-4');
        ...
        batch_card.innerHTML = `
                     <div class="card-dashboard ">
                            <div class="flex flex-row items-start w-full gap-4">
                                ...
                                <div class="w-full">
                                    <p class="card-title">Total Batch Received</p>
                                    <h3 class="card-value">${data.totalBatches}</h3>
                                </div>
                     ...
                     <div class="card-dashboard ">
                            <div class="flex flex-row items-start w-full gap-4">
                                <div
                                    ...
                                    <div class="bg-yellow-400 text-white w-16 h-16 rounded-full flex items-center justify-center">
                                        <!-- Archive Icon -->
                                          <svg class="w-10 h-10" fill="none" stroke="white" stroke-width="2" viewBox="0 0 24 24">
                                ...
                                <div class="w-full">
                                    <p class="card-title">Total Product Received</p>
                                    <h3 class="card-value">${data.totalItems}</h3>
                                </div>
                     ...
                     <div class="card-dashboard ">
                            <div class="flex flex-row items-start w-full gap-4">
                                <div
                                    ...
                                    <div class="bg-green-600 text-white w-16 h-16 rounded-full flex items-center justify-center">
                                        <!-- Archive Icon -->
                                        <svg fill="currentColor" class="w-10 h-10" viewBox="0 0 52 52" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg">
                                <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                                <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                                <g id="SVGRepo_iconCarrier">
                                    <path
                                ...
                                <div class="w-full">
                                    <p class="card-title">Under Warranty Products</p>
                                    <h3 class="card-value">${data.total_under_warranty}</h3>
                                </div>
                            ...
                            <div class="flex flex-row items-start w-full gap-4">
                                <div
                                    ...
                                    <div class="bg-red-600 text-white w-16 h-16 rounded-full flex items-center justify-center">
                                        <!-- Archive Icon -->
                               <svg viewBox="0 0 16 16" class="w-10 h-10" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                                    <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                                    <g id="SVGRepo_iconCarrier">
                                ...
                                <div class="w-full">
                                    <p class="card-title">Out of Warranty Products</p>
                                    <h3 class="card-value">${data.total_out_of_warranty}</h3>
                                </div>
        ...
        learnersDataContainer.classList.add('grid', 'md:grid-cols-5', 'grid-cols-1', 'gap-4', 'my-4');
                     ...
                     <div class="card-dashboard ">
                            <div class="flex flex-row items-start w-full gap-4">
                                <div
                                    ...
                                    <div class="bg-blue-400 text-white w-16 h-16 rounded-full flex items-center justify-center">
                                        <!-- Archive Icon -->
                               <svg class="w-10 h-10" version="1.1" id="_x32_" xmlns="http://www.w3.org/2000/svg"
                                ...
                                <div class="w-full">
                                    <p class="card-title">Total No. of Learners</p>
                                    <h3 class="card-value">${data.totalLearners}</h3>
                                </div>
                     ...
                     <div class="card-dashboard ">
                            <div class="flex flex-row items-start w-full gap-4">
                                <div
                                    ...
                                    <svg fill="currentColor" class="w-10 h-10" viewBox="0 0 56 56" xmlns="http://www.w3.org/2000/svg">
                                        <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                                        <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                                        <g id="SVGRepo_iconCarrier">
                                            <path
                                ...
                                <div class="w-full">
                                    <p class="card-title">Total No. of Teachers</p>
                     ...
                     <div class="card-dashboard ">
                            <div class="flex flex-row items-start w-full gap-4">
                                <div
                                    ...
                                    <div class="bg-blue-400 text-white w-16 h-16 rounded-full flex items-center justify-center">
                                        <!-- Archive Icon -->
                                        <svg fill="currentColor" class="w-10 h-10" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                                <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                                                <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                                                <g id="SVGRepo_iconCarrier">
                                                    <path
                                ...
                                <div class="w-full">
                                    <p class="card-title">Total No. of Classrooms</p>
                                    <h3 class="card-value">${data.totalClassrooms}</h3>
                                </div>
                     ...
                     <div class="card-dashboard ">
                            <div class="flex flex-row items-start w-full gap-4">
                                <div
                                    ...
                                    <div class="bg-blue-400 text-white w-16 h-16 rounded-full flex items-center justify-center">
                                        <!-- Archive Icon -->
                                        <svg viewBox="0 0 64 64" class="w-10 h-10" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                ...
                                <div class="w-full">
                                    <p class="card-title">Total No. of  Sections</p>
                                    <h3 class="card-value">${data.totalSections}</h3>
                                </div>
        ...
        const productsListContainer = document.getElementById('dcp-card-condition');
        ...
        Object.entries(products).map(([key, value], index) => {
            ...
            card.innerHTML = `
            <div class="card-macaron ${bgColor[index]}">
                <div class="w-full">
        ...
        packages.forEach((package, index) => {
            ...
            card.innerHTML = `
            <a href="${url}">
            <div class="card-macaron text-center flex items-center ${bgColor[index]}">
                <div class="w-full">
    ...
    async function getConditionData() {
        ...
        bgColor.reverse();
        try {
            const response = await fetch('/School/get-current-conditions');
