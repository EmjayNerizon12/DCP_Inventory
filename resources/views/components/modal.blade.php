<div id="{{ $id }}" class="modal hidden z-99">
	<!-- Backdrop -->
	<!-- Modal -->
	@php
		...
		<div class="mb-2 p-6">
			<div class="flex flex-col items-center justify-center ">
				<div class="flex justify-center  relative items-center">
					...
					<img id="school-logo"
						src="{{ optional(optional(Auth::guard('school')->user())->school)->image_path
						    ? asset('school-logo/' . optional(Auth::guard('school')->user())->school->image_path)
						    : asset('icon/logo.png') }}"    
						class="w-24 h-24 rounded-full border border-gray-300 object-cover shadow-lg">
					<div class="  absolute bottom-0 right-0 translate-x-1/2 w-14 h-14 action-button">
