         ...
         <form action="{{ route('schools.employee.update') }}" method="POST" enctype="multipart/form-data">
             ...
             <div class="flex flex-col items-center justify-center gap-2">
                 ...
                 <div class="w-full text-center">
                     ...
                     <div class="page-subtitle">Update the information needed for the employee</div>
                 </div>
             </div>
             ...
             <div class="grid md:grid-cols-3 grid-cols-1 gap-4 mb-4">
                 ...
                 <div>
                     ...
                     <input type="text" name="employee_number" required id="employee_number"
                         class="w-full border border-gray-400 rounded px-2 py-1">
                 </div>
                 <div>
                 ...
                 <div>
                     ...
                     <input type="text" required name="salary_grade" id="salary_grade"
                         class="w-full border border-gray-400 rounded px-2 py-1">
                 </div>
                 <!-- Emails -->
                 <div>
                     <label for="deped_email">Deped Email <span class="text-red-600">(required)</span></label>
                     <input type="email" required name="deped_email" id="deped_email"
                         class="w-full border border-gray-400 rounded px-2 py-1">
                 </div>
                 <div>
                 ...
                 <div>
                     <label for="officer_in_charge">Officer in Charge <span
                             class="text-red-600">(required)</span></label>
                     <select name="officer_in_charge" required id="officer_in_charge"
                         class="w-full border border-gray-400 rounded px-2 py-1">
                 ...
                 <div>
                     ...
                     <select name="inactive" id="inactive" required
                         class="w-full border border-gray-400 rounded px-2 py-1">
                         <option value="0">No</option>
                         <option value="1">Yes</option>
                     </select>
             ...
             <div class="flex md:justify-end justify-center gap-2 mt-4">
                 <button type="button" onclick="closeEditModal()"
                     class="btn-cancel md:w-auto w-full px-4 py-1 rounded">
                     Cancel
                 </button>
