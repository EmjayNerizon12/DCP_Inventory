  ...
  @section('content')
      ...
      <div class="md:p-6 p-2">
          ...
          <div class="spinner-container my-4" id="card-spinner">
              ...
              <div class="w-full">
                  ...
                  <div class="flex justify-start gap-2 w-full  ">
                      ...
                      <input placeholder="Search by Name or Employee Number" type="text"
                          class="form-input w-base max-w-sm" id="searchTerm">
                      <button type="button" class="theme-button px-4 py-1 rounded-md" id="search"
                          onclick="searchEmployee()">Search</button>
                  </div>
              </div>
              <div class="flex flex-col justify-start   ">
                  <div class="form-label">Employee List</div>
                  <div>

                      <button title="Show Info Modal" type="button" onclick="openModal()" class="theme-button w-auto">
                          Add Employee
                      </button>
                  </div>
              </div>
