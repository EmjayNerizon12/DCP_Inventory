<div id="school_others"
    class=" col-span-4 flex md:flex-row max-w-xl md:mx-auto   flex-col gap-2 overflow-hidden mb-10  max-w-full sm:px-0 lg:px-0 pt-0 ">
    ...
    @if (isset($schoolData) && count($schoolData))
        <div>
            ...
            <div>
                ...
                <button type="button" onclick="addSchoolData()" class="theme-button  py-1 px-4 rounded my-2">
                    Insert Data
                </button>
                ...
                @foreach ($schoolData as $data)
                    <div class="mb-6">
                        ...
                        <div class="gap-2 w-full p-2 flex  justify-end  items-center p-0 bg-white">
